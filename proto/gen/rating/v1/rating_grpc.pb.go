...
const (
	RatingService_Price_FullMethodName = "/rating.v1.RatingService/Price"
)
...
//
// RatingService turns token usage into cost using a versioned price catalog.
// Metering calls it for every usage event (with a built-in fallback).
...
func (c *ratingServiceClient) Price(ctx context.Context, in *PriceRequest, opts ...grpc.CallOption) (*PriceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PriceResponse)
	err := c.cc.Invoke(ctx, RatingService_Price_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRatingServiceServer) Price(context.Context, *PriceRequest) (*PriceResponse, error) {
...
func _RatingService_Price_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RatingServiceServer).Price(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RatingService_Price_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatingServiceServer).Price(ctx, req.(*PriceRequest))
	}
...
var RatingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Price",
			Handler:    _RatingService_Price_Handler,
		},
	},
